 ...
 * in their GetRequirements() method, and resources used within a subsystem should
...
class Subsystem {
 public:
   ...
   * subsystem-specific state that you don't want to offload to a Command.  Teams should
